...
#define VVAX_TELNET_OUT_FIFO_BYTES  4096
#define VVAX_TELNET_DIAG_FIFO_BYTES 1024
#define VVAX_TELNET_IN_FIFO_BYTES   4096

EXT_RAM_BSS_ATTR static uint8_t telnet_out_storage[VVAX_TELNET_OUT_FIFO_BYTES];
EXT_RAM_BSS_ATTR static uint8_t telnet_diag_storage[VVAX_TELNET_DIAG_FIFO_BYTES];
EXT_RAM_BSS_ATTR static uint8_t telnet_in_storage[VVAX_TELNET_IN_FIFO_BYTES];
...
static void send_shell_banner() {
  g_pipe.socket().print(
      "\r\nvVax management shell\r\n"
      "Guest continues; Telnet I/O is temporarily detached.\r\n"
      "Type help for commands, exit to return to the console.\r\n"
      "Escape sequence: ESC >\r\n"
      "vVax:/> ");
}
