...
// L3 NAT helper (from vpdp1170 DEUNA path). Used by vVax for secondary
// DELQA/DEQNA-class guest Ethernet: ARP + gateway ICMP locally; outbound
// IPv4 UDP/TCP/ICMP rewritten onto the WiFi STA address (userspace NAPT).
namespace eth_nat {
